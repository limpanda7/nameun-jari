...
const spaceMMS = (date, time, person, purpose, price) => {
  return '안녕하세요 온오프스페이스 입니다 :)\n' +
    ...
    '\n' +
    '* 예약 시 주의사항\n'+
    '★출입 도어락은 입실 1시간 전 알려드립니다★\n'+
    '1. 입퇴실은 정시기준입니다. 미리 도착하거나 퇴실이 늦어질 연락 꼭 부탁드립니다.\n'+
    '(시간 초과 시 5분당 1000원 추가요금 발생합니다 )\n'+
    '2. 금연공간입니다\n'+
    '3. 화장실은 외부 통로에 있습니다. (화장실용 슬리퍼고 갈아신어 주세요)\n'+
    '4. 사용하신 모든 집기 및 소품은 제자리에 놓아주세요. (비치된 물품 파손및 분실 시 배상금이 청구될 수 있습니다.)\n'+
    '5. 퇴실 시 냉난방기 및 출입문을 확인해주세요.\n'+
