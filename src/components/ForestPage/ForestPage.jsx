          ...
          >
            ...
            <div className="additional-charges">
              ...
              <div className="charges-grid">
                ...
                <div className="charge-item free">
                  <span className="charge-label">36개월 미만 영유아</span>
                  <span className="charge-price">무료</span>
                  <span className="charge-note">(추가 요금 없음)</span>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          ...
          >
            ...
            <div className="booking-note">
              <p>위 버튼을 클릭하여 예약 가능한 일정을 확인하고 예약하세요.</p>
              <p>상세한 이용 안내와 예약 가능 일정을 안내해드립니다.</p>
            </div>
          </motion.div>
        </div>
      </section>
